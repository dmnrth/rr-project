...
```{r}
packages <- c("xts", "DT", 'tidyverse', 'patchwork')
...
tabelka ze statyskykami z artykułu i napisaćco sie zgadza 
...
# model estimation \# results comparison \# problems encountered
