...
data <- read.csv(file=csv_file_path, sep= ",",colClasses=c("NULL",NA,NA,NA,NA,NA,NA,NA,NA,NA,NA,NA),)
...
```{r Case_1, fig.cap="Equity curves of ARIMA(p,1,q) & ARIMA(p,1,q)-SGARCH(1,1).", fig.width=12, fig.height=5, results='hide'}
library(ggplot2) 
...
```{r Case_2, fig.cap="Equity curves of ARIMA(p,1,q) & ARIMA(p,1,q)-EGARCH(1,1).", fig.width=12, fig.height=5, results='hide'}
library(ggplot2) 
...
```{r Case_3, fig.cap="Equity curves of ARIMA(p,1,q)-SGARCH(1,1) with different window sizes.", fig.width=12, fig.height=5, results='hide'}
library(ggplot2) 
...
```{r Case_4, fig.cap="Equity curves of all hybrid models with different distributions.", fig.width=12, fig.height=5, results='hide'}
library(ggplot2) 
